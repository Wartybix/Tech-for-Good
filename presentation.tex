...
\begin{frame}{Server-Side Filtering}
    A control layer at the client's side can further reduce false-positives by comparing suspected pothole location data with locations of known obstacles like speed bumps.
