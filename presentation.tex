...
\begin{frame}{The Council's Side}
    \begin{itemize}
        ...
        \item Potholes with higher reported shock strengths can be marked as high-priority, as they are more dangerous.
    \end{itemize}    
\end{frame}
...
\begin{frame}{Pothole Completion}
    \begin{columns}
        ...
        \begin{figure}
            \includegraphics[width=4.2cm]{mark-as-filled.png}
